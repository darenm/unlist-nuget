...
class Action {
    constructor(packageId, versionRegex, nugetKey) {
        if (packageId) {
    ...
    getPackageVersions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield _http.get(uri);
            const body = yield res.readBody();
            const versions = JSON.parse(body);
            return versions;
        });
    }
    deletePackageVersion(version) {
        return __awaiter(this, void 0, void 0, function* () {
            const _http = new httpm.HttpClient('unlist-nuget');
    ...
    relistPackageVersion(version) {
        return __awaiter(this, void 0, void 0, function* () {
            const _http = new httpm.HttpClient('unlist-nuget');
            const additionalHeaders = { ['X-NuGet-ApiKey']: this.nuGetKey };
            const uri = `https://www.nuget.org/api/v2/package/${this.packageId}/${version}`;
            const res = yield _http.post(uri, '', additionalHeaders);
            return res.message.statusCode === 200 ? true : false;
        });
    }
    matchVersionsToRegExp(versions) {
...
const action = new action_1.Action(process.env.INPUT_NUGET_PACKAGE || process.env.NUGET_PACKAGE, process.env.INPUT_VERSION_REGEX || process.env.VERSION_REGEX, process.env.INPUT_NUGET_KEY || process.env.NUGET_KEY);
action.run();
